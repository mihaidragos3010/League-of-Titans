...
const App = () => {
    ...
    useEffect(() => {
        if (isLoggedIn && mapRef.current && !mapRef.current.hasChildNodes()) {
            ...
            const squares = [
                { color: [255, 0, 0, 0.5], center: { longitude: 26.1, latitude: 44.43 } },
                { color: [255, 255, 0, 0.5], center: { longitude: 26.105, latitude: 44.43 } },
                { color: [0, 255, 0, 0.5], center: { longitude: 26.11, latitude: 44.43 } },
            ];
    ...
    const renderContent = () => {
        ...
        return (
            <div style={{ display: "flex", flexDirection: "column", height: "100vh", margin: 0 }}>
                <div className="tab-navigation" style={{ display: "flex", padding: "10px", background: "#f8f9fa" }}>
                    <button
                ...
                <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
                    <div style={{ flex: "1", overflowY: "auto", padding: "10px", background: "#fff", borderRight: "1px solid #ddd" }}>
                        {activeTab === "locations" && (
