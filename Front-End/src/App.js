...
const App = () => {
    ...
    const filterLocations = () => {
        ...
        graphicsLayerRef.current.graphics.items.forEach((graphic) => {
            ...
            if (graphic.geometry.spatialReference.wkid !== userLocationGeometry.spatialReference.wkid) {
                console.warn("Spatial references do not match. Skipping graphic.");
                return;
            }

            const distanceToUser = distance(userLocationGeometry, graphic.geometry, "kilometers");
